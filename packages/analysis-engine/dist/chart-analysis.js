import { PERSONAL_ANALYSIS_V1 } from './config/analysis-profile.js';
...
export function analyzeChart(chart, profile = PERSONAL_ANALYSIS_V1) {
    ...
    const yogas = detectAllYogas(planetFacts, houseFacts, houseLordFacts, conjunctions, aspects, dignities);
    return {
