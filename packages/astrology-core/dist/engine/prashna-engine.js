...
export async function calculatePrashnaChart(input) {
    ...
    const chart = await engine.calculateBirthChart({ birthTime, location: input.location }, PERSONAL_VEDIC_V1);
    return {
...
//# sourceMappingURL=prashna-engine.js.map