import {
  BranchName,
  EarthlyBranchDetails,
  FiveElement,
  HeavenlyStemDetails,
  StemName,
} from '../types/bazi-types.js';

export const HEAVENLY_STEMS: Record<StemName, HeavenlyStemDetails> = {
...
export const STEM_ORDER: StemName[] = [
  'Jia',
  'Yi',
  'Bing',
  'Ding',
...
export const EARTHLY_BRANCHES: Record<BranchName, EarthlyBranchDetails> = {
  Zi: {
    name: 'Zi',
    chinese: '子',
    pinyin: 'Zǐ',
...
export const BRANCH_ORDER: BranchName[] = [
  'Zi',
  'Chou',
  'Yin',
  'Mao',
 ...
 */
export const FIVE_TIGER_SEEK_START: Record<StemName, StemName> = {
  Jia: 'Bing',
  Ji: 'Bing',
  Yi: 'Wu',
  Geng: 'Wu',
 ...
 */
export const FIVE_RAT_SEEK_START: Record<StemName, StemName> = {
  Jia: 'Jia',
  Ji: 'Jia',
  Yi: 'Bing',
  Geng: 'Bing',
...
export const ELEMENT_GENERATING_CYCLE: Record<FiveElement, FiveElement> = {
  Wood: 'Fire',
  Fire: 'Earth',
  Earth: 'Metal',
  Metal: 'Water',
...
export const ELEMENT_CONTROLLING_CYCLE: Record<FiveElement, FiveElement> = {
  Wood: 'Earth',
  Earth: 'Water',
  Water: 'Fire',
  Fire: 'Metal',
