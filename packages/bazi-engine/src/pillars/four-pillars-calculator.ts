...
export const SOLAR_TERMS_12: SolarTermInfo[] = [
 ...
 */
export function getTropicalSunLongitude(chart: BirthChart): number {
 ...
 */
export function resolveSolarTermMonth(sunLongitude: number): SolarTermInfo {
 ...
 */
export function calculateJulianDayNumber(utcIsoString: string): number {
 ...
 */
export function calculateDayGanzhiIndex(jdn: number): number {
 ...
 */
export function calculateFourPillars(chart: BirthChart): FourPillars {
  ...
  const yearEvidence: BaZiEvidence = {
    pillarName: 'YEAR',
    stem: yearStemName,
  ...
  const monthEvidence: BaZiEvidence = {
    pillarName: 'MONTH',
    stem: monthStemName,
  ...
  const dayEvidence: BaZiEvidence = {
    pillarName: 'DAY',
    stem: dayStemName,
  ...
  const hourEvidence: BaZiEvidence = {
    pillarName: 'HOUR',
    stem: hourStemName,
