import { ELEMENT_CONTROLLING_CYCLE, ELEMENT_GENERATING_CYCLE, } from '../constants/ganzhi-constants.js';
export function classifyTenGod(dayMaster, targetStem) {
 ...
 */
export function populateTenGods(fourPillars) {
