...
export function evaluateDignityStrength(
  planet: PlanetName,
  analysis: ChartAnalysisResult,
  signLordRelationship?: CompoundRelationshipResult,
  profile?: StrengthProfile
): { dignityName: string; factor: StrengthFactor } {
  ...
  let dignityKey = primary as string;
  let scoreContrib = 0;
  let effect: 'SUPPORTIVE' | 'CHALLENGING' | 'NEUTRAL' = 'NEUTRAL';
