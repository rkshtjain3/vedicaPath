...
export type OverallStrength = 'VERY_STRONG' | 'STRONG' | 'MODERATE' | 'WEAK' | 'VERY_WEAK';
...
export type CompoundRelationship = 'GREAT_FRIEND' | 'FRIEND' | 'NEUTRAL' | 'ENEMY' | 'GREAT_ENEMY';
...
export type RelationshipMatrix = Record<string, Record<string, CompoundRelationshipResult>>;
