...
export const SouthIndianChart = ({ viewModel, selectedPlanet, selectedHouse, showAspectRays = true, onSelectPlanet, onSelectHouse, className = '', }) => {
    const ascSignId = viewModel.ascendantSignId;
    // Compute aspect rays if planet selected
    let activeAspects = [];
    let sourceHouseNum = null;
    let sourceSignId = null;
    ...
    return (_jsx("div", { className: `relative w-full max-w-[480px] aspect-square mx-auto ${className}`, children: _jsxs("svg", { viewBox: "0 0 400 400", className: "w-full h-full select-none", role: "img", "aria-label": `${viewModel.title} (South Indian Style)`, children: [_jsxs("defs", { children: [_jsxs("linearGradient", { id: "southBg", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [_jsx("stop", { offset: "0%", stopColor: "#0f172a" }), _jsx("stop", { offset: "100%", stopColor: "#020617" })] }), _jsxs("filter", { id: "rayGlowSouth", children: [_jsx("feGaussianBlur", { stdDeviation: "1.5", result: "coloredBlur" }), _jsxs("feMerge", { children: [_jsx("feMergeNode", { in: "coloredBlur" }), _jsx("feMergeNode", { in: "SourceGraphic" })] })] }), _jsx("marker", { id: "aspectArrowSouth", viewBox: "0 0 10 10", refX: "6", refY: "5", markerWidth: "5", markerHeight: "5", orient: "auto-start-reverse", children: _jsx("path", { d: "M 0 1.5 L 10 5 L 0 8.5 z", fill: "#38bdf8" }) }), _jsx("marker", { id: "aspectSpecialArrowSouth", viewBox: "0 0 10 10", refX: "6", refY: "5", markerWidth: "5", markerHeight: "5", orient: "auto-start-reverse", children: _jsx("path", { d: "M 0 1.5 L 10 5 L 0 8.5 z", fill: "#fbbf24" }) })] }), _jsx("rect", { width: "400", height: "400", fill: "url(#southBg)", rx: "16", stroke: "#334155", strokeWidth: "2" }), _jsx("rect", { x: "100", y: "100", width: "200", height: "200", fill: "#020617", stroke: "#334155", strokeWidth: "2" }), _jsxs("g", { transform: "translate(200, 200)", children: [_jsx("text", { y: "-15", textAnchor: "middle", fill: "#a5b4fc", fontFamily: "monospace", fontSize: "13px", fontWeight: "bold", letterSpacing: "0.05em", children: viewModel.title }), _jsxs("text", { y: "5", textAnchor: "middle", fill: "#94a3b8", fontFamily: "monospace", fontSize: "11px", children: ["Lagna: ", _jsx("tspan", { fill: "#fcd34d", fontWeight: "bold", children: viewModel.ascendantSign })] }), _jsx("text", { y: "24", textAnchor: "middle", fill: "#64748b", fontFamily: "monospace", fontSize: "10px", children: "South Indian Format" })] }), SOUTH_SIGN_BOXES.map((box) => {
                    ...
                    return (_jsxs("g", { children: [_jsx("rect", { x: box.x, y: box.y, width: "100", height: "100", fill: fillColor, stroke: strokeColor, strokeWidth: strokeWidth, className: "cursor-pointer transition-colors hover:opacity-90", onClick: () => house && onSelectHouse?.(house), role: "button", tabIndex: 0, "aria-label": `Sign ${house?.sign}, House ${houseNum}`, onKeyDown: (e) => {
                                    if ((e.key === 'Enter' || e.key === ' ') && house) {
                                        onSelectHouse?.(house);
                                    }
                                } }), isLagna && (_jsx("line", { x1: box.x, y1: box.y, x2: box.x + 30, y2: box.y + 30, stroke: "#f59e0b", strokeWidth: "2.5" })), _jsxs("text", { x: box.x + 8, y: box.y + 14, fill: "#94a3b8", fontFamily: "monospace", fontSize: "10px", fontWeight: "bold", children: ["H", houseNum, " ", _jsxs("tspan", { fill: "#818cf8", children: ["(", box.signId, ")"] })] }), isLagna && (_jsx("text", { x: box.x + 92, y: box.y + 14, textAnchor: "end", fill: "#fbbf24", fontFamily: "monospace", fontSize: "10px", fontWeight: "bold", children: "ASC" })), house && (_jsx("g", { transform: `translate(${box.x + 50}, ${box.y + 55})`, children: renderSouthPlanetGroup(house.planets, selectedPlanet, onSelectPlanet, houseNum) }))] }, `sign-box-${box.signId}`));
                }), sourceSignId &&
                    activeAspects.map((aspect) => {
                        ...
                        return (_jsx("g", { children: _jsx("line", { x1: sourceBox.x + 50, y1: sourceBox.y + 50, x2: targetBox.x + 50, y2: targetBox.y + 50, stroke: strokeColor, strokeWidth: "2.2", strokeDasharray: "6 3", strokeLinecap: "round", filter: "url(#rayGlowSouth)", markerEnd: marker, opacity: "0.9" }) }, `south-aspect-ray-${aspect.targetHouse}`));
                    })] }) }));
};
function renderSouthPlanetGroup(planets, selectedPlanet, onSelectPlanet, houseNum) {
