 ...
 */
export function getRelativeHouse(
  ...
  if (
    ...
    throw new Error(
      `Invalid sign index provided to getRelativeHouse: source=${sourceSignIndex}, target=${targetSignIndex}. Indices must be between 1 and 12.`
    );
  }
