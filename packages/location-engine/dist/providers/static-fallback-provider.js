import { searchCountries } from '../countries/country-dataset.js';
export const STATIC_GLOBAL_CITIES = [
    // India
    {
...
export class StaticFallbackLocationProvider {
    ...
    async searchCities(query, countryCode) {
        ...
        return list.filter((l) => l.city.toLowerCase().includes(trimmed) ||
...
//# sourceMappingURL=static-fallback-provider.js.map