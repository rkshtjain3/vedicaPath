...
export function extractEntities(rawQuestion, profile = PERSONAL_QUERY_V1) {
    ...
    for (const [dom, keywords] of Object.entries(profile.domainKeywords)) {
    ...
    for (const [pName, aliases] of Object.entries(profile.planetAliases)) {
