import { PERSONAL_RULES_V1 } from '../profiles/rules-profile.js';
...
export function evaluateRulesEngine(context, profile = PERSONAL_RULES_V1) {
    const domains = {
        CAREER: {
            domain: 'CAREER',
    ...
    const domainList = ['CAREER', 'WEALTH', 'RELATIONSHIPS', 'PROPERTY'];
...
//# sourceMappingURL=rules-aggregator.js.map