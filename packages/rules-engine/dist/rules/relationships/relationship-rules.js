...
export const relRule004 = {
    ...
    evaluate(context) {
        ...
        const maleficAspectingHouse7 = context.analysis.aspects.filter((asp) => malefics.includes(asp.fromPlanet) && asp.toHouse === 7);
        ...
        if (house7Lord) {
            const maleficAspectingLord7 = context.analysis.aspects.filter((asp) => malefics.includes(asp.fromPlanet) && asp.targetPlanets.includes(house7Lord));
...
export const relationshipRulesList = [
    relRule001,
    relRule002,
    relRule003,
    relRule004,
];
//# sourceMappingURL=relationship-rules.js.map