...
export class D10Career005Rule {
    ...
    evaluate(context, profile = PERSONAL_CAREER_D10_RULES_V1) {
        ...
        const crossFacts = careerCrossChart ||
        ...
        const effectClassification = profile.ruleEffects['D10-CAREER-005'][effectKey] || 'NEUTRAL';
        const whyEvidence = [
...
//# sourceMappingURL=career-d10-005.js.map