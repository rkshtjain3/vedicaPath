...
export const wealthRule004 = {
    ...
    evaluate(context) {
        ...
        const isConnected = jupConn2.connected || jupConn11.connected || venConn2.connected || venConn11.connected;
        const evidence = [];
...
export const wealthRulesList = [
    wealthRule001,
    wealthRule002,
    wealthRule003,
    wealthRule004,
];
//# sourceMappingURL=wealth-rules.js.map