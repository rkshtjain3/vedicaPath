...
export const careerRule004 = {
    id: 'CAREER-004',
    domain: 'CAREER',
    version: '1.0.0',
    evaluate(context) {
        const jupiterAspects = context.analysis.aspects.filter((asp) => asp.fromPlanet === 'Jupiter' && asp.toHouse === 10);
...
export const careerRule005 = {
    ...
    evaluate(context) {
        ...
        const saturnAspects = context.analysis.aspects.filter((asp) => asp.fromPlanet === 'Saturn' && asp.toHouse === 10);
...
//# sourceMappingURL=career-rules.js.map