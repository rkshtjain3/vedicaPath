...
export type PrimaryDignity = 'EXALTED' | 'MOOLATRIKONA' | 'OWN_SIGN' | 'FRIENDLY_SIGN' | 'NEUTRAL_SIGN' | 'ENEMY_SIGN' | 'DEBILITATED';
...
export type YogaCategory = 'MAHAPURUSHA' | 'RAJA' | 'DHANA' | 'LUNAR' | 'SPECIAL';
...
export type YogaEvidenceType = 'PLANET_POSITION' | 'HOUSE_LORDSHIP' | 'ASPECT' | 'CONJUNCTION' | 'DIGNITY' | 'HOUSE_RELATIONSHIP' | 'CANCELLATION';
