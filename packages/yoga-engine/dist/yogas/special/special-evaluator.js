...
export function evaluateSpecialYogas(planetFacts, houseLordFacts, conjunctions, aspects, dignities, methodologyVersion) {
    const results = [];
    // 1. BUDHA_ADITYA_YOGA
    const baConditions = [];
    const baEvidence = [];
    ...
    // 3. PARIVARTANA_YOGA
    const parivartanaConditions = [];
    const parivartanaEvidence = [];
