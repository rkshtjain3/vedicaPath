 ...
 */
export function calculateAkshavedamsaPosition(sourceLongitude: number): DivisionalPosition {
  ...
  if (category === 'FIXED') startSignId = 5; // Leo for Fixed
  if (category === 'DUAL') startSignId = 9; // Sagittarius for Dual
