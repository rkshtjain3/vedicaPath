export type BenchmarkCategory = 'ASTROLOGY' | 'ASTROLOGY_CHART' | 'DASHA' | 'DIVISIONAL' | 'ASHTAKAVARGA' | 'SHADBALA' | 'TIMING' | 'NORMAL_INDIAN' | 'MIDNIGHT_BIRTH' | 'LAGNA_BOUNDARY' | 'NAKSHATRA_BOUNDARY' | 'DATE_BOUNDARY' | 'DST_AMBIGUOUS' | 'DST_NON_EXISTENT' | 'FOREIGN_LOCATION' | 'HIGH_LATITUDE' | 'HISTORICAL' | 'EXALTATION_BOUNDARY' | 'DEBILITATION_BOUNDARY' | 'DIVISIONAL_BOUNDARY';
export type ValidationStatus = 'NOT_VALIDATED' | 'READY_FOR_REFERENCE' | 'REFERENCE_ENTERED' | 'PASS' | 'FAIL' | 'STALE' | 'IMPLEMENTED_UNBENCHMARKED' | 'BENCHMARK_VALIDATED' | 'BENCHMARK_MISMATCH' | 'PARTIAL_IMPLEMENTATION' | 'INTERNAL_INVARIANT_PASS' | 'REFERENCE_BENCHMARK_PASS' | 'PARTIALLY_VALIDATED';
export type DriftStatus = 'MATCH' | 'INPUT_CHANGED' | 'PROFILE_CHANGED' | 'ENGINE_CHANGED' | 'CONFIGURATION_CHANGED' | 'UNKNOWN';
export type RootCauseClassification = 'INPUT_TIMEZONE' | 'DST_RESOLUTION' | 'DST_HANDLING' | 'LOCATION_COORDINATES' | 'AYANAMSHA' | 'EPHEMERIS' | 'TRUE_VS_MEAN_NODE' | 'LONGITUDE_BOUNDARY' | 'SIGN_BOUNDARY' | 'NAKSHATRA_BOUNDARY' | 'HOUSE_SYSTEM' | 'DIVISIONAL_CHART_RULE' | 'DIVISIONAL_MAPPING_ERROR' | 'DASHA_YEAR_BASIS' | 'DASHA_CALCULATION_VARIANT' | 'FORMULA_VARIANT' | 'REFERENCE_DATA_ERROR' | 'IMPLEMENTATION_BUG' | 'UNKNOWN';
export type InvestigationStatus = 'UNINVESTIGATED' | 'INVESTIGATING' | 'EXPLAINED' | 'FIXED' | 'REFERENCE_CORRECTED';
...
export type VerificationStatus = 'UNVERIFIED' | 'SOURCE_CAPTURED' | 'REVIEWED' | 'VERIFIED' | 'INCOMPLETE' | 'REJECTED';
export type ReferenceCoverageStatus = 'NO_REFERENCE' | 'PARTIAL_REFERENCE' | 'COMPLETE_REFERENCE' | 'NOT_AVAILABLE' | 'PARTIAL' | 'COMPLETE';
export type ValidationExecutionResult = 'NOT_RUN' | 'NOT_VALIDATED' | 'PASS' | 'FAIL' | 'PARTIAL_PASS' | 'INCOMPARABLE_CONFIGURATION';
