import { ConfidenceLevel, ConfidenceMetadata, DomainEvidenceItem } from '../types.js';
...
export function calculateConfidence(
  ...
  const disclaimer =
    'Confidence level reflects data completeness and multi-engine convergence. It does not represent predictive certainty or guaranteed real-world outcomes.';
