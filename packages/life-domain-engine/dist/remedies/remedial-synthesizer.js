...
export function synthesizeVedicRemedies(chart) {
    const remedies = [];
    ...
    return {
        remedies,
        generalRemedialGuidance: 'Vedic remedies focus on harmonizing planetary frequency vibrations through sound recitations (Mantras) and elemental redistribution (Dāna). Gemstones are prescribed strictly when functional lords are benefic and non-afflicted.',
    };
}
//# sourceMappingURL=remedial-synthesizer.js.map