export function findAuspiciousWindows(chart, options) {
    ...
    for (let i = 0; i < horizonDays; i++) {
        ...
        if (dayIdx === 4 || dayIdx === 5)
            baseScore += 15; // Thu/Fri auspicious
        if (dayIdx === 2 && intention !== 'MEDICAL_PROCEDURE')
            baseScore -= 15; // Tuesday caution except surgery
...
//# sourceMappingURL=event-muhurtha-finder.js.map