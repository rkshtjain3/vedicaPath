...
export function calculateSthanaBala(
  ...
  house: number,
  d1Sign: RashiDetails,
  d9Sign: RashiDetails | undefined,
  saptavarga: SthanaBalaSubcomponent
): SthanaBalaComponent {
  ...
  const totalVirupas =
    uchcha.virupas + saptavarga.virupas + ojayugma.virupas + kendradi.virupas + drekkana.virupas;
  ...
  return {
    ...
    saptavargaStatus: {
      status: saptavarga.status as any,
