...
export type ShadbalaComponentName =
  | 'STHANA_BALA'
  | 'DIG_BALA'
  | 'NAISARGIKA_BALA'
  | 'CHESHTA_BALA'
...
export type SthanaSubcomponentName =
  | 'UCHCHA_BALA'
  | 'SAPTAVARGAJA_BALA'
  | 'OJAYUGMA_BALA'
  | 'KENDRADI_BALA'
...
export type KaalaSubcomponentName =
  | 'NATHONNATA_BALA'
  | 'PAKSHA_BALA'
  | 'TRIBHAGA_BALA'
  | 'VARSHA_MASA_DINA_HORA_BALA'
  | 'AYANA_BALA'
  | 'YUDDHA_BALA';
...
export type ShadbalaFormulaStatus =
...
export type ShadbalaBenchmarkStatus =
  | 'NOT_VALIDATED'
  | 'PARTIALLY_VALIDATED'
  | 'VALIDATED';
...
export interface ShadbalaProfile {
  version: string; // e.g. "personal-shadbala-v1"
  unit: ShadbalaUnit;
  virupaPerRupa: number; // 60
