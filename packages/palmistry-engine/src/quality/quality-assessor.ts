import { ImageQualityAssessment, PalmistryInputPayload } from '../types/palmistry-types.js';

export function assessImageQuality(payload: PalmistryInputPayload): ImageQualityAssessment {
