...
export function calculateConfidence(params: {
  ...
  if (mixedSignals.mixedSignals) {
    score -= 10;
    rationale.push(
      `Preserved mixed signals: ${mixedSignals.supportiveCount} supportive vs ${mixedSignals.challengingCount} challenging factors`
    );
  }
  ...
  const disclaimer =
    'Confidence level represents consistency and volume of structured evidence within the configured astrological framework. It does NOT represent scientific probability or guaranteed real-world outcomes.';
