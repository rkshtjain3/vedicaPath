import { classifyRuleEvaluation, classifyDashaActivations, classifyTransitEvaluations, } from '../../factors/factor-classifier.js';
...
export function interpretPropertyDomain(params) {
    ...
    if (timingStatus) {
        if (timingStatus.dashaActivation) {
            const dashaFactors = classifyDashaActivations(timingStatus.dashaActivation, 'PROPERTY');
...
//# sourceMappingURL=property-interpretation.js.map