...
export function evaluateInterpretationEngine(params) {
    ...
    return {
        calculationProfileVersion: rulesResult.calculationProfileVersion || timingResult?.calculationProfileVersion || 'personal-vedic-v1',
        analysisProfileVersion: rulesResult.analysisProfileVersion || timingResult?.analysisProfileVersion || 'personal-analysis-v1',
