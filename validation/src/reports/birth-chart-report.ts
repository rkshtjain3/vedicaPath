...
export function generateBirthChartValidationReport(
  result: BirthChartRunResult,
  ...
  for (const d of result.details) {
    ...
    lines.push(
      `[${d.status}] ${d.category.padEnd(16)} | ${d.planetOrKey}.${d.field}: Exp='${d.expectedValue}', Act='${d.actualValue}'${diffStr}`
    );
  }
  lines.push('');
