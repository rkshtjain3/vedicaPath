export function classifyMismatch(comparisonResults, benchmarkCase) {
    ...
    if (boundaryFails.length > 0) {
        candidates.push({
            ...
            likelihood: 'HIGH',
            evidence: boundaryFails.map((b) => `Planet/Point ${b.planetOrKey} is positioned near sign boundary (${b.actualValue}°).`),
...
//# sourceMappingURL=mismatch-classifier.js.map