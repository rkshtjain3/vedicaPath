...
export async function runUnifiedBenchmark(testCase) {
    ...
    const dashaResults = runDashaBenchmark(testCase, dashaResult.mahadashas, chart.birthNakshatra?.name || moonPlanet?.nakshatra?.name);
    // 3. Divisional
    ...
    // 5. Shadbala
    const analysisResult = { planetFacts: [] }; // Mock or actual analysis
...
//# sourceMappingURL=unified-runner.js.map